...
public class CreateComment extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit = (Button)findViewById(R.id.post_comment_sumbit);
    ...
    public void onClick(View view) {
        ...
        if(id == R.id.post_comment_sumbit){
           ...
           // Log.e("Checking", nameOfUser);
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.PUT, url, sumbitField, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    if(response.optString("status").equals("Comment Successful")){
                        Intent Intent = new Intent(CreateComment.this,SoloPost.class);
                        Intent.putExtra("url","https://raymondsfypapi.herokuapp.com/api/viewIndpost/"+url.substring(url.indexOf("post/")+5,url.indexOf("/comment")));
                        finish();
                        startActivity( Intent);
                    }else{
                        Intent Intent = new Intent(CreateComment.this,CreateComment.class);
                        finish();
                        startActivity( Intent);
                    }
